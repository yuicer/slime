...
var light = {
	get_light: function () {
		...
		vs.light[0].position.set(20, 40, -15);
		//		vs.light[0].target.position.copy(vs.scene.position);
		vs.light[0].castShadow = true;
		vs.light[0].shadow.camera.left = -60;
		vs.light[0].shadow.camera.top = -60;
		vs.light[0].shadow.camera.right = 60;
		vs.light[0].shadow.camera.bottom = 60;
